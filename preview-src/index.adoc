...
tabs sync
add page attribute `:tabs-sync-option:`
...
.This is interactive
image::multirepo-ssg.svg[Multirepo SSG,300,225,opts=interactive]

.This is inline
image::multirepo-ssg.svg[Multirepo SSG,300,225,opts=inline]

.This is interactive with Links
image::svg-with-link.svg[opts=interactive]

.This is inline with Links
image::svg-with-link.svg[opts=inline]
